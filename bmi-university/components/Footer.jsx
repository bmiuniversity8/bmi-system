    ...
    <footer style={{ background: "#0a1628", color: "#fff", fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <Link href="/" aria-label="BMI University — Home" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
            <img src="/images/bmi-crest-270.png" alt="BMI University Crest" style={{ height: "56px", width: "auto", objectFit: "contain" }} />
            <div style={{ display: "flex", flexDirection: "column", lineHeight: 1 }}>
              <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 900, fontSize: "1.85rem", color: "#fff", letterSpacing: "-0.02em", lineHeight: 1 }}>BMI</span>
              <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: "0.6rem", color: "#d4af37", letterSpacing: "0.18em", textTransform: "uppercase", marginTop: "3px" }}>University</span>
            </div>
          </Link>
