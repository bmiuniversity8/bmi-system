      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <Link href="/" aria-label="BMI University — Home" style={{ display: "flex", alignItems: "center", gap: "12px", textDecoration: "none" }}>
            ...
            <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 900, fontSize: "1.2rem", color: "#fff", lineHeight: 1.2 }}>
              BMI<br />
              <span style={{ color: "#d4af37", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" }}>University</span>
            </span>
          </Link>
