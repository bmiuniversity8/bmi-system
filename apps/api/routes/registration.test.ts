...
vi.mock('../lib/email', () => ({
  ...
  registrationCompleteEmail: vi.fn().mockReturnValue('<html></html>'),
  courseEnrollmentConfirmationEmail: vi.fn().mockReturnValue('<html></html>'),
  registrationProgressEmail: vi.fn().mockReturnValue('<html></html>'),
